...
export const MainBanner = () => {
    return (
        <section className="w-full h-[480px] relative border-b-2 border-gray100 bg-gray50 overflow-hidden">
            ...
            <Image src={DecorationImg_2} alt="Banner 이미지" width={240} height={164} className="absolute left-10 top-[88px] object-cover rounded-3xl w-[240px] h-[164px] transition-all animate-[rightToLeft_1s]" />
            <Image src={DecorationImg_3} alt="Banner 이미지" width={164} height={240} className="absolute left-[296px] top-[88px] object-cover rounded-3xl w-[164px] h-[240px] transition-all sm:hidden md:hidden animate-[upToDown_1s]" />
            <Image src={DecorationImg_4} alt="Banner 이미지" width={164} height={240} className="absolute left-[116px] top-[268px] object-cover rounded-3xl w-[164px] h-[240px] transition-all sm:hidden animate-[upToDown_1s]" />
            <Image src={DecorationImg_5} alt="Banner 이미지" width={164} height={240} className="absolute right-[296px] top-[159px] object-cover rounded-3xl w-[164px] h-[240px] transition-all sm:hidden md:hidden animate-[upToDown_1s]" />
            <Image src={DecorationImg_6} alt="Banner 이미지" width={164} height={240} className="absolute right-[116px] top-[40px] object-cover rounded-3xl w-[164px] h-[240px] transition-all sm:right-[40px] animate-[downToUp_1s]" />
            <Image src={DecorationImg_7} alt="Banner 이미지" width={164} height={240} className="absolute -right-10 top-[296px] object-cover rounded-3xl w-[320px] h-[240px] transition-all animate-[leftToRight_1s]" />
            <div className="w-[100vw] h-[480px] absolute bg-[rgba(255,255,255,0.52)] flex justify-center items-center px-4">
                <div className="flex flex-col gap-8 items-center">
                    ...
                    <div className="flex gap-3 break-keep">
                        <Button kind="primary" size="small">더 많은 지원서</Button>
                        <Button kind="blue" size="small">지원서 공유하기</Button>
                    </div>
                </div>
            </div>
        </section>
