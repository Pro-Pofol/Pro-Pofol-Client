...
export const TipBox = ({ title, name, date }: TipBoxProps) => {
    return (
        <div className="p-8 flex sm:flex-col w-full gap-2.5 justify-between items-center sm:items-start border border-gray100 bg-white rounded-3xl">
            <span className="text-titleSmall text-black truncate w-full">{title}</span>
            <div className="text-bodyMedium text-gray600 flex justify-end items-center gap-2 w-fit sm:w-full text-nowrap">
                <span>{name}</span>
