...
export const Footer = () => {
  return (
    <footer className="py-10 bg-white text-black flex justify-center border-t-2 border-gray100 w-full">
      <section className="px-10 flex flex-col gap-10 max-w-[1280px] w-full">
        <section className="flex gap-4">
          <div className="w-[180px] flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-1.5 text-gray800">
              <span className="text-labelMedium cursor-pointer">
                지원서 공유하기
              </span>
        ...
        <section className="flex gap-10 flex-1 sm:flex-col">
          <div className="flex flex-col w-full gap-3">
            ...
            <p className="text-labelMedium text-gray500 break-keep">
              대표자: 강혁리 | 개인정보보호책임자: 태곤임 | 이메일:
              gang@gang.com | 문의: 010-0000-0000
            </p>
            <p className="text-labelMedium text-gray500 break-keep">
