import { Facebook, Github, Phone, PropofolFullLogo, PropofolLogo } from "@/assets"
            ...
            <section className="px-10 flex flex-col gap-10 max-w-[1280px] w-full">
                ...
                <section className="flex gap-10 flex-1">
                    <div className="flex flex-col w-full gap-3">
                        <div className="flex gap-3 items-center text-labelLarge text-gray700">
                            <Link href="/">
                                <Image src={PropofolFullLogo} alt="프로포폴 로고" height={32} className="h-8 w-auto" />
                            </Link>                            <div className="w-px h-4 rounded bg-gray500" />
                            <span className="cursor-pointer">이용약관</span>
                            <div className="w-px h-4 rounded bg-gray500" />
                    ...
                    <div className="flex flex-1 gap-3 justify-end items-end text-gray800">
